...
def create_datasets(args):
    ...
    if 'Set5' in args.eval_sets:
        ...
        set5  = Benchmark(set5_hr_path, set5_lr_path, scale=args.upscale, colors=args.colors)
    ...
    if 'Set14' in args.eval_sets:
        ...
        set14 = Benchmark(set14_hr_path, set14_lr_path, scale=args.upscale, colors=args.colors)
    ...
    if 'B100' in args.eval_sets:
        ...
        b100  = Benchmark(b100_hr_path, b100_lr_path, scale=args.upscale, colors=args.colors)
    ...
    if 'Urban100' in args.eval_sets:
        ...
        u100  = Benchmark(u100_hr_path, u100_lr_path, scale=args.upscale, colors=args.colors)
    ...
    if 'Manga109' in args.eval_sets:
        ...
        manga = Benchmark(manga_hr_path, manga_lr_path, scale=args.upscale, colors=args.colors)
